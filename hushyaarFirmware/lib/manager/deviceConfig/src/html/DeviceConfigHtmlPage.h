const char DEVICE_CONFIG_PAGE_HTML [] PROGMEM = R"rawliteral(
        <!DOCTYPE html>
        <html lang="en" dir="rtl">
        <head>
            <meta charset="utf-8">
            <title>
                هوشیار | تنظیمات دستگاه
            </title>
            <meta name="viewport" content="width=device-width, initial-scale=1">
            <style>
            body{font-family:Tahoma;}
            input[type=text]{font-family:Tahoma;font-size:18px;}
            input[type=tel]{font-family:Tahoma;font-size:18px;}
            ...
            li{margin:0 10px 10px 0; width:180px;}
            hr{margin:10px 0 30px 0;}
            dl dt { float: right;}
            dl dt { font-weight: bold;margin-left: 5px;}
            </style>
        </head>
        <body>
            ...
            <hr>
            <form action="/deviceConfig" method="POST">
            <legend>
                اطلاعات مربوط به تنظیمات دستگاه را وارد کنید.
            </legend>
            <ul>
                <li>
                <label for="deviceId">
